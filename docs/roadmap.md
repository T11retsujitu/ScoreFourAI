...
| 10 | 幾何・解放関係評価 (実験・ユーザー仮説) | ⏳ | [`experiments/geometric_relational_eval.md`](experiments/geometric_relational_eval.md) |
...
Stage A（線形・関係特徴）→ 有望なら Stage B（柱 N-tuple `[3][31]`）の順。実装は本計画の承認後。
